...
namespace Taki_Client
{
    class JoinGamePanel: Panel
    {
        ...
        public void Initialize()
        {
            ...
            Bitmap image = new Bitmap("C:\\Cyber\\Taki\\Taki\\Taki_Client\\Taki_Client\\Resources\\Taki Logo.jpg");
        ...
        void joinGame_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string jsonArgs = json.args;
                if (code != "success")
                    return;
                dynamic args = JsonConvert.DeserializeObject(jsonArgs);
                string gameID = args.game_id;
                string jwt = args.jwt;
                GameLobbyPlayer panel = new GameLobbyPlayer(gameID, this.passwordInput.Text, jwt, socket);
